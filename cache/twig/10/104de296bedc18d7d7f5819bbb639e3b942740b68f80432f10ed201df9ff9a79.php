...
class __TwigTemplate_e11a513967f869c4e69de9baa1610fdbc38ec8a6dcdfd4883cbff1d0ec98d8fb extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_slice($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "find", array(0 => "/galerie"), "method"), "collection", array()), 0, 4));
        $context['loop'] = array(
...
";
    ...
    public function getSourceContext()
    {
        ...
        <div class=\"container\">
            <div class=\"row\">
                <div id=\"last-news-item\">
                    {% for child in page.find('/galerie').collection |slice(0, 4) %}

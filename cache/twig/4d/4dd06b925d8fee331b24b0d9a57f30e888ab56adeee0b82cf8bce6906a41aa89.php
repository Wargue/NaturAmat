...
class __TwigTemplate_888dcfe21426c077eb8b0c44f9deaa12927798e45e18588e59d6389e6d522414 extends Twig_Template
{
  ...
  ";
        // line 13
        if (( !($context["language"] ?? null) && $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "language", array()), "enabled", array()))) {
            // line 14
            echo "    ";
            $context["language"] = $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "language", array()), "getLanguage", array());
            // line 15
            echo "  ";
        }
        // line 16
  ...
  <script type=\"text/javascript\">
    var disqus_config = function () {
        this.language        = '";
        // line 19
        echo twig_escape_filter($this->env, (((isset($context["language"]) || array_key_exists("language", $context))) ? (_twig_default_filter(($context["language"] ?? null), "en")) : ("en")), "js");
        echo "';
        this.shortname       = '";
        // line 20
        ...
        this.page.title      = '";
        // line 21
        echo twig_escape_filter($this->env, (((isset($context["title"]) || array_key_exists("title", $context))) ? (_twig_default_filter(($context["title"] ?? null), $this->getAttribute(($context["page"] ?? null), "title", array()))) : ($this->getAttribute(($context["page"] ?? null), "title", array()))), "js");
        echo "';
        this.page.url        = '";
        // line 22
        echo twig_escape_filter($this->env, (((isset($context["url"]) || array_key_exists("url", $context))) ? (_twig_default_filter(($context["url"] ?? null), $this->getAttribute(($context["page"] ?? null), "url", array(0 => true, 1 => true), "method"))) : ($this->getAttribute(($context["page"] ?? null), "url", array(0 => true, 1 => true), "method"))), "js");
        echo "';
        this.page.identifier = '";
        // line 23
        echo twig_escape_filter($this->env, (((isset($context["id"]) || array_key_exists("id", $context))) ? (_twig_default_filter(($context["id"] ?? null), $this->env->getExtension('Grav\Common\Twig\TwigExtension')->md5Filter($this->getAttribute(($context["page"] ?? null), "rawRoute", array(), "method")))) : ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->md5Filter($this->getAttribute(($context["page"] ?? null), "rawRoute", array(), "method")))), "js");
        echo "';
    };
...
", "plugins/jscomments/disqus.html.twig", "C:\\wamp\\www\\Naturamat\\user\\plugins\\jscomments\\templates\\plugins\\jscomments\\disqus.html.twig");
    }
}

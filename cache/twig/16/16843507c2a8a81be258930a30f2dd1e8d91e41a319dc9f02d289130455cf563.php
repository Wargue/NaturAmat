...
/* comments.html.twig */
class __TwigTemplate_ffe6ac0ac37a2db23b72d3389273fac1964d4e104248074c05231354f2a222b7 extends Twig_Template
{
...
";
    ...
    <div class=\"admin-block\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "comments", array()), "comments", array()));
        ...
        ";
        // line 99
        if (($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "comments", array()), "totalRetrieved", array()) < $this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "comments", array()), "totalAvailable", array()))) {
            // line 100
        ...
        // line 105
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "comments", array()), "totalRetrieved", array()), "html", null, true);
        echo "</span> comments of <span class=\"totalAvailable\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "comments", array()), "totalAvailable", array()), "html", null, true);
        echo "</span></p>
    </div>

    ";
        // line 108
        if ($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "pages", array())) {
            // line 109
        ...
        <div class=\"admin-block\">
            ...
            // line 119
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array()), "pages", array()));
...
", "comments.html.twig", "C:\\wamp\\www\\Naturamat\\user\\plugins\\comments\\admin\\templates\\comments.html.twig");
    }
}
